...
if (moyenne < 10) {
    console.log(`Le candidat est récalé car il a obtenu une moyenne de ${moyenne}`);
} else if (moyenne >= 10 && moyenne <= 12) {
    console.log(`Le candidat est reçu car il a obtenu une moyenne de ${moyenne}`);
} else if (moyenne >= 12) {
    console.log(`Le candidat est reçu avec une mention  il a obtenu une moyenne de ${moyenne}`);
}
